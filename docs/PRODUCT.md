...
> Estado alinhado à versão desktop `0.23.6`. Para decisões, validações e histórico completo, consultar `PROJECT_CONTEXT.md`.
...
6. Perfil do rodapé: identidade, papel, modal de informações e futura foto/avatar.
